...
four subjects across 482 parcels:
\begin{equation}
r_{\text{ceiling}} = 0.2247, \qquad 95\%\ \text{CI}\ [0.2147,\ 0.2363].
\end{equation}
...
\item \textbf{English-language corpus from five specific sources.} The measured spread is a
property of this corpus, not of media in general, and the bound inherits that.
