...
classifier against pre-scan dataset-derived labels?
...
\item Validate the index as a classifier against pre-scan dataset-derived labels.
...
\item \textbf{Individual items cannot be judged.} $12.8\%$ of items reverse direction between
