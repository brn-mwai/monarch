...
before the result wherever the result appears. A second scanning session over 375 items gives
test-retest $\mathrm{ICC} = 0.8757$ and replicates the separation at $\eta^2 = 0.0839$, while
$13.1\%$ of individual items reverse direction between sessions, so the instrument supports
...
a 400-item corpus, and the field bound it yields.} 10 pages. Prepared for \emph{Physica A} as
