...
$d = 0.491$, so the null is a symmetric response rather than an absent one. Each category is drawn from a single source dataset, so the separation is between
