...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{../../services/inference/data/figures/B2_roi_means_fear_activating.pdf}
\caption{Fear-activating category mean painted on the two ROI unions. Colour is uniform inside
each region: the scan reduces each item to two values, so this shows ROI means and not
vertexwise activation.}
\label{fig:roi-means}
\end{figure}
